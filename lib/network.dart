...
/// A short " ( testnet )" / " ( regtest )" suffix for the active network, or an
/// empty string on mainnet. Append to a label (e.g. an account name) so the
/// active network is visible without cluttering the common mainnet case.
String networkSuffix(ZNetwork net) {
  switch (net) {
    case ZNetwork.mainnet:
      return "";
    case ZNetwork.testnet:
