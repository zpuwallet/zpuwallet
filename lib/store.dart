...
class AppSettingsNotifier extends _$AppSettingsNotifier {
  ...
  Future<AppSettings> build() async {
    ...
    final blockChunkSize = (hasDb ? await getProp(key: "block_chunk_size", c: c) : null) ?? "500";
...
sealed class AppSettings with _$AppSettings {
  factory AppSettings({
    ...
    required String blockChunkSize, // blocks per GetBlockRange window
    ...
    while (true) {
      try {
        ...
        final progress = synchronize(
          ...
          blockChunkSize: int.parse(settings.blockChunkSize),
          fast: true,
          c: c,
        );
