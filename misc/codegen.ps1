...
# as a NativeCommandError and would abort the script even on success. Many tools
# (cargo, flutter_rust_bridge_codegen, dart) write warnings/progress to stderr, so
...
# user only needs the VS "Desktop development with C++" workload), then PATH.
